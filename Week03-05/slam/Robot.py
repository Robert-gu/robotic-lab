...
class Robot:
    ...
    def drive(self, drive_meas):
        ...
        # ------------------------------------------
        self.state[0]=self.state[0]+linear_velocity*np.cos(self.state[2])
        self.state[1]=self.state[1]+linear_velocity*np.sin(self.state[2])
        self.state[2]=self.state[2]+self.angular_velocity*dt
